...
The R package is in the [streamfind GitHub repository](https://github.com/ricardo-cunha/streamfind) of the
...
the GitHub *url* https://github.com/ricardo-cunha/streamfind. This should create a local image of the streamfind repository

...
namespace mass_spec
{
  namespace reader
  {
    ...
    public:
      ...
      mass_spec::spectra::MS_TARGETS_SPECTRA get_spectra_targets(const mass_spec::spectra::MS_TARGETS &targets, const MS_SPECTRA_HEADERS &hd, const float &minIntLv1, const float &minIntLv2);

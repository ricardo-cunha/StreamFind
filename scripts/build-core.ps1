<#
    ...
    Usage:
      ...
      powershell -ExecutionPolicy Bypass -File scripts\build-core.ps1 -Clean
      powershell -ExecutionPolicy Bypass -File scripts\build-core.ps1 -Tests
      powershell -ExecutionPolicy Bypass -File scripts\build-core.ps1 -Target streamfind_mass_spec_nta_processing_tests

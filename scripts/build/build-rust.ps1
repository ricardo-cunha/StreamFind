<#
    ...
    Usage:
      powershell -ExecutionPolicy Bypass -File scripts\build\build-rust.ps1
      powershell -ExecutionPolicy Bypass -File scripts\build\build-rust.ps1 -Clean
      powershell -ExecutionPolicy Bypass -File scripts\build\build-rust.ps1 -Tests
      powershell -ExecutionPolicy Bypass -File scripts\build\build-rust.ps1 -Package streamfind-rust-mass-spec

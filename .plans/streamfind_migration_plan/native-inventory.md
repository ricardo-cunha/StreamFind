...
| --- | --- |
| mzML | `bindings/r/dev/dev_reader/example_files/karl.mzML` |
| mzXML | No committed representative fixture identified in the initial scan |
| Shimadzu TXT | `bindings/r/dev/dev_reader/example_files/karl.txt` |
| ASC | No committed representative fixture identified in the initial scan |
| Shimadzu LCD | `bindings/r/dev/dev_reader/example_files/karl.lcd`, `260115_ADC_angepasst.lcd` |
...
Before moving files, use the following existing fixtures where available. The
paths below are the Phase 1 destinations; until relocation, the same files are
under the root `dev/` tree:

- `bindings/r/dev/dev_reader/example_files/karl.mzML`
- `bindings/r/dev/dev_reader/example_files/karl.txt`
- `bindings/r/dev/dev_reader/example_files/260115_ADC_angepasst.txt`
- `bindings/r/dev/dev_reader/example_files/karl.lcd`
- `bindings/r/dev/dev_reader/example_files/260115_ADC_angepasst.lcd`

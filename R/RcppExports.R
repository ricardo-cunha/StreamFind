...
rcpp_project_nta_metfrag_screening <- function(nta_xptr, metfrag_path, database_type = "PubChem", database_path = "", database = NULL, analyses = as.character( c("")), ppm = 5.0, sec = 10.0, ppmMS2 = 10.0, mzrMS2 = 0.008, top_n = 1L, score_types = as.character( c("FragmenterScore")), score_weights = as.numeric( c(1.0)), pre_processing_candidate_filter = as.character( c("UnconnectedCompoundFilter", "IsotopeFilter")), post_processing_candidate_filter = as.character( c("InChIKeyFilter")), maximum_tree_depth = 2L, number_threads = 1L, use_smiles = TRUE, filtered = FALSE, java_path = "java", run_dir = "", extra_params = NULL) {
    .Call(`_streamfind_rcpp_project_nta_metfrag_screening`, nta_xptr, metfrag_path, database_type, database_path, database, analyses, ppm, sec, ppmMS2, mzrMS2, top_n, score_types, score_weights, pre_processing_candidate_filter, post_processing_candidate_filter, maximum_tree_depth, number_threads, use_smiles, filtered, java_path, run_dir, extra_params)
}
